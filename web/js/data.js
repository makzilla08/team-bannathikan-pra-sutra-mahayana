...
const SUTRAS_DATA = [
    ...
    },
    {
        ...
        chapters: [
            ...
            { id: 2, title_thai: "บทที่ 2", status: "completed" },
            { id: 3, title_thai: "บทที่ 3", status: "completed" },
            { id: 4, title_thai: "บทที่ 4", status: "completed" },
            { id: 5, title_thai: "บทที่ 5", status: "completed" },
            { id: 6, title_thai: "บทที่ 6", status: "completed" },
            { id: 7, title_thai: "บทที่ 7", status: "completed" },
            { id: 8, title_thai: "บทที่ 8", status: "completed" },
            { id: 9, title_thai: "บทที่ 9", status: "completed" },
            { id: 10, title_thai: "บทที่ 10", status: "completed" },
            { id: 11, title_thai: "บทที่ 11", status: "completed" },
            { id: 12, title_thai: "บทที่ 12", status: "completed" },
            { id: 13, title_thai: "บทที่ 13", status: "completed" },
            { id: 14, title_thai: "บทที่ 14", status: "completed" },
    ...
    },
    {
        ...
        title_english: "Mahayana Mahaparinirvana Sutra",
        priority: 7,
        status: "completed",
        description: "พระสูตรมหายานว่าด้วยการปรินิพพานของพระตถาคต พุทธธรรมชาติ และอัตตาที่แท้จริง (46 บท)",
        chapters_count: 46,
        chapters: [
            { id: 1, title_thai: "บทที่ 1 - บทนำ (Introductory)", status: "completed" },
            { id: 2, title_thai: "บทที่ 2 - ว่าด้วยจุนท (On Cunda)", status: "completed" },
            { id: 3, title_thai: "บทที่ 3 - ว่าด้วยความโศก (On Grief)", status: "completed" },
            { id: 4, title_thai: "บทที่ 4 - ว่าด้วยอายุยืน (On Long Life)", status: "completed" },
            { id: 5, title_thai: "บทที่ 5 - ว่าด้วยพระวชิรกาย (On the Adamantine Body)", status: "completed" },
            { id: 6, title_thai: "บทที่ 6 - ว่าด้วยคุณแห่งพระนาม (On the Virtue of the Name)", status: "completed" },
            { id: 7, title_thai: "บทที่ 7 - ว่าด้วยสี่ลักษณะ (On the Four Aspects)", status: "completed" },
            { id: 8, title_thai: "บทที่ 8 - ว่าด้วยสี่ที่พึ่ง (On the Four Dependables)", status: "completed" },
            { id: 9, title_thai: "บทที่ 9 - ว่าด้วยผิดและถูก (On Wrong and Right)", status: "completed" },
            { id: 10, title_thai: "บทที่ 10 - ว่าด้วยอริยสัจสี่ (On the Four Truths)", status: "completed" },
            { id: 11, title_thai: "บทที่ 11 - ว่าด้วยวิปาลาสสี่ (On the Four Inversions)", status: "completed" },
            { id: 12, title_thai: "บทที่ 12 - ว่าด้วยตถาคตครรภ์ (On the Nature of the Tathagata)", status: "completed" },
            { id: 13, title_thai: "บทที่ 13 - ว่าด้วยอักษร (On Letters)", status: "completed" },
            { id: 14, title_thai: "บทที่ 14 - ว่าด้วยนิทานนก (On the Parable of the Birds)", status: "completed" },
            { id: 15, title_thai: "บทที่ 15 - ว่าด้วยนิทานจันทร์ (On the Parable of the Moon)", status: "completed" },
            { id: 16, title_thai: "บทที่ 16 - ว่าด้วยพระโพธิสัตว์ (On the Bodhisattva)", status: "completed" },
            { id: 17, title_thai: "บทที่ 17 - ว่าด้วยปัญหาของหมู่ชน (On the Questions Raised by the Crowd)", status: "completed" },
            { id: 18, title_thai: "บทที่ 18 - ว่าด้วยอาพาธที่แท้จริง (On Actual Illness)", status: "completed" },
            { id: 19, title_thai: "บทที่ 19 - ว่าด้วยอริยธรรม (ก) (On Holy Actions a)", status: "completed" },
            { id: 20, title_thai: "บทที่ 20 - ว่าด้วยอริยธรรม (ข) (On Holy Actions b)", status: "completed" },
            { id: 21, title_thai: "บทที่ 21 - ว่าด้วยบริสุทธิธรรม (ก) (On Pure Actions a)", status: "completed" },
            { id: 22, title_thai: "บทที่ 22 - ว่าด้วยบริสุทธิธรรม (ข) (On Pure Actions b)", status: "completed" },
            { id: 23, title_thai: "บทที่ 23 - ว่าด้วยบริสุทธิธรรม (ค) (On Pure Actions c)", status: "completed" },
            { id: 24, title_thai: "บทที่ 24 - ว่าด้วยบริสุทธิธรรม (ง) (On Pure Actions d)", status: "completed" },
            { id: 25, title_thai: "บทที่ 25 - ว่าด้วยบริสุทธิธรรม (จ) (On Pure Actions e)", status: "completed" },
            { id: 26, title_thai: "บทที่ 26 - ว่าด้วยอาการแห่งบุตร (On the Action of the Child)", status: "completed" },
            { id: 27, title_thai: "บทที่ 27 - พระมหากษัตริย์ผู้เปี่ยมศีล (ก) (Highly-Virtuous King a)", status: "completed" },
            { id: 28, title_thai: "บทที่ 28 - พระมหากษัตริย์ผู้เปี่ยมศีล (ข) (Highly-Virtuous King b)", status: "completed" },
            { id: 29, title_thai: "บทที่ 29 - พระมหากษัตริย์ผู้เปี่ยมศีล (ค) (Highly-Virtuous King c)", status: "completed" },
            { id: 30, title_thai: "บทที่ 30 - พระมหากษัตริย์ผู้เปี่ยมศีล (ง) (Highly-Virtuous King d)", status: "completed" },
            { id: 31, title_thai: "บทที่ 31 - พระมหากษัตริย์ผู้เปี่ยมศีล (จ) (Highly-Virtuous King e)", status: "completed" },
            { id: 32, title_thai: "บทที่ 32 - พระมหากษัตริย์ผู้เปี่ยมศีล (ฉ) (Highly-Virtuous King f)", status: "completed" },
            { id: 33, title_thai: "บทที่ 33 - พระโพธิสัตว์สิงหราช (ก) (Lion's Roar a)", status: "completed" },
            { id: 34, title_thai: "บทที่ 34 - พระโพธิสัตว์สิงหราช (ข) (Lion's Roar b)", status: "completed" },
            { id: 35, title_thai: "บทที่ 35 - พระโพธิสัตว์สิงหราช (ค) (Lion's Roar c)", status: "completed" },
            { id: 36, title_thai: "บทที่ 36 - พระโพธิสัตว์สิงหราช (ง) (Lion's Roar d)", status: "completed" },
            { id: 37, title_thai: "บทที่ 37 - พระโพธิสัตว์สิงหราช (จ) (Lion's Roar e)", status: "completed" },
            { id: 38, title_thai: "บทที่ 38 - พระโพธิสัตว์สิงหราช (ฉ) (Lion's Roar f)", status: "completed" },
            { id: 39, title_thai: "บทที่ 39 - พระโพธิสัตว์สิงหราช (ช) (Lion's Roar g)", status: "completed" },
            { id: 40, title_thai: "บทที่ 40 - พระโพธิสัตว์กัสยป (ก) (Kasyapa a)", status: "completed" },
            { id: 41, title_thai: "บทที่ 41 - พระโพธิสัตว์กัสยป (ข) (Kasyapa b)", status: "completed" },
            { id: 42, title_thai: "บทที่ 42 - พระโพธิสัตว์กัสยป (ค) (Kasyapa c)", status: "completed" },
            { id: 43, title_thai: "บทที่ 43 - พระโพธิสัตว์กัสยป (ง) (Kasyapa d)", status: "completed" },
            { id: 44, title_thai: "บทที่ 44 - พระโพธิสัตว์กัสยป (จ) (Kasyapa e)", status: "completed" },
            { id: 45, title_thai: "บทที่ 45 - ว่าด้วยโกณฑินยะ (ก) (Kaundinya a)", status: "completed" },
            { id: 46, title_thai: "บทที่ 46 - ว่าด้วยโกณฑินยะ (ข) (Kaundinya b)", status: "completed" },
        ],
        source_url: "https://www.wisdomlib.org/buddhism/book/the-mahayana-mahaparinirvana-sutra"
    },
    {
        id: 36,
        dsbc_book_id: 36,
    ...
    },
    {
        id: 142,
        dsbc_book_id: 78,
        folder: "15_manjusrimumlakalpa",
        title_thai: "มัญชุศรีมูลกัลป์",
        title_sanskrit: "Āryamañjuśrīmūlakalpam",
        title_english: "Āryamañjuśrīmūlakalpa (Kriyā Tantra)",
        priority: 15,
        status: "completed",
        description: "ตันตระว่าด้วยพิธีกรรมและมนตร์ของพระมัญชุศรีโพธิสัตว์ เป็นคัมภีร์หลักของกริยาตันตระ (Kriyā Tantra) ว่าด้วยการสร้างมณฑล พิธีกรรม และการสวดมนตร์",
        chapters_count: 55,
        chapters: [
            { id: 1, title_thai: "บทที่ ๑", status: "completed" },
            { id: 2, title_thai: "บทที่ ๒", status: "completed" },
            { id: 3, title_thai: "บทที่ ๓", status: "completed" },
            { id: 4, title_thai: "บทที่ ๔", status: "completed" },
            { id: 5, title_thai: "บทที่ ๕", status: "completed" },
            { id: 6, title_thai: "บทที่ ๖", status: "completed" },
            { id: 7, title_thai: "บทที่ ๗", status: "completed" },
            { id: 8, title_thai: "บทที่ ๘", status: "completed" },
            { id: 9, title_thai: "บทที่ ๙", status: "completed" },
            { id: 10, title_thai: "บทที่ ๑๐", status: "completed" },
            { id: 11, title_thai: "บทที่ ๑๑", status: "completed" },
            { id: 12, title_thai: "บทที่ ๑๒", status: "completed" },
            { id: 13, title_thai: "บทที่ ๑๓", status: "completed" },
            { id: 14, title_thai: "บทที่ ๑๔", status: "completed" },
            { id: 15, title_thai: "บทที่ ๑๕", status: "completed" },
            { id: 16, title_thai: "บทที่ ๑๖", status: "completed" },
            { id: 17, title_thai: "บทที่ ๑๗", status: "completed" },
            { id: 18, title_thai: "บทที่ ๑๘", status: "completed" },
            { id: 19, title_thai: "บทที่ ๑๙", status: "completed" },
            { id: 20, title_thai: "บทที่ ๒๐", status: "completed" },
            { id: 21, title_thai: "บทที่ ๒๑", status: "completed" },
            { id: 22, title_thai: "บทที่ ๒๒", status: "completed" },
            { id: 23, title_thai: "บทที่ ๒๓", status: "completed" },
            { id: 24, title_thai: "บทที่ ๒๔", status: "completed" },
            { id: 25, title_thai: "บทที่ ๒๕", status: "completed" },
            { id: 26, title_thai: "บทที่ ๒๖", status: "completed" },
            { id: 27, title_thai: "บทที่ ๒๗", status: "completed" },
            { id: 28, title_thai: "บทที่ ๒๘", status: "completed" },
            { id: 29, title_thai: "บทที่ ๒๙", status: "completed" },
            { id: 30, title_thai: "บทที่ ๓๐", status: "completed" },
            { id: 31, title_thai: "บทที่ ๓๑", status: "completed" },
            { id: 32, title_thai: "บทที่ ๓๒", status: "completed" },
            { id: 33, title_thai: "อักษรและมนตรวิทยา", status: "completed" },
            { id: 34, title_thai: "มุทราตันตระ", status: "completed" },
            { id: 35, title_thai: "มุทราวิธี", status: "completed" },
            { id: 36, title_thai: "มุทราลักษณะและมหามุทรา", status: "completed" },
            { id: 37, title_thai: "มันตรมุทราวิธี", status: "completed" },
            { id: 38, title_thai: "มุทรมณฑล", status: "completed" },
            { id: 39, title_thai: "ฌาน (สมาธิ)", status: "completed" },
            { id: 40, title_thai: "ฌานและนาค", status: "completed" },
            { id: 41, title_thai: "บทที่ ๔๑", status: "completed" },
            { id: 42, title_thai: "บทที่ ๔๒", status: "completed" },
            { id: 43, title_thai: "บทที่ ๔๓", status: "completed" },
            { id: 44, title_thai: "บทที่ ๔๔", status: "completed" },
            { id: 45, title_thai: "บทที่ ๔๕", status: "completed" },
            { id: 46, title_thai: "บทที่ ๔๖", status: "completed" },
            { id: 47, title_thai: "บทที่ ๔๗", status: "completed" },
            { id: 48, title_thai: "บทที่ ๔๘", status: "completed" },
            { id: 49, title_thai: "บทที่ ๔๙", status: "completed" },
            { id: 50, title_thai: "บทที่ ๕๐", status: "completed" },
            { id: 51, title_thai: "บทที่ ๕๑", status: "completed" },
            { id: 52, title_thai: "บทที่ ๕๒", status: "completed" },
            { id: 53, title_thai: "บทที่ ๕๓", status: "completed" },
            { id: 54, title_thai: "บทที่ ๕๔", status: "completed" },
            { id: 55, title_thai: "บทที่ ๕๕", status: "completed" }
        ],
    ...
    },
    {
        id: 143,
        dsbc_book_id: 84,
        folder: "16_sarvatathagatatattvasangraha",
        title_thai: "สรวะตถาคตทัตวาสังคหะ",
        title_sanskrit: "Sarva tathāgata tattva saṅgrahaḥ",
        title_english: "Sarva Tathāgata Tattva Saṅgraha (Yoga Tantra)",
        priority: 16,
        status: "completed",
        description: "ตันตระว่าด้วยการรวมตัตตวะแห่งพระตถาคตทั้งปวง เป็นคัมภีร์หลักของโยคตันตระ (Yoga Tantra) ว่าด้วยวัชรธาตุมณฑล พิธีอภิเษก และสมาธิแห่งพระโพธิสัตว์ทั้ง ๕๗ พระองค์",
        chapters_count: 26,
        chapters: [
            { id: 1, title_thai: "ปฐมาธิยาย", title_sanskrit: "Prathamaḥ", status: "completed" },
            { id: 2, title_thai: "ทุติยาธยาย", title_sanskrit: "Dvitīyaḥ", status: "completed" },
            { id: 3, title_thai: "ตติยาธยาย", title_sanskrit: "Tṛtīyaḥ", status: "completed" },
            { id: 4, title_thai: "จตุรฺถาธยาย", title_sanskrit: "Caturthaḥ", status: "completed" },
            { id: 5, title_thai: "ปัญจมธยาย", title_sanskrit: "Pañcamaḥ", status: "completed" },
            { id: 6, title_thai: "ษัษฐมธยาย", title_sanskrit: "Ṣaṣṭhamaḥ", status: "completed" },
            { id: 7, title_thai: "สัปตมธยาย", title_sanskrit: "Saptamaḥ", status: "completed" },
            { id: 8, title_thai: "อัษฏมธยาย", title_sanskrit: "Aṣṭamaḥ", status: "completed" },
            { id: 9, title_thai: "นวมธยาย", title_sanskrit: "Navamaḥ", status: "completed" },
            { id: 10, title_thai: "ทศมธยาย", title_sanskrit: "Daśamaḥ", status: "completed" },
            { id: 11, title_thai: "เอกาทศมธยาย", title_sanskrit: "Ekādaśamaḥ", status: "completed" },
            { id: 12, title_thai: "ทวาทศมธยาย", title_sanskrit: "Dvādaśamaḥ", status: "completed" },
            { id: 13, title_thai: "ตรโยทศมธยาย", title_sanskrit: "Trayodaśamaḥ", status: "completed" },
            { id: 14, title_thai: "จตุรฺทศมธยาย", title_sanskrit: "Caturdaśamaḥ", status: "completed" },
            { id: 15, title_thai: "ปัญจทศมธยาย", title_sanskrit: "Pañcadaśamaḥ", status: "completed" },
            { id: 16, title_thai: "โษฑศมธยาย", title_sanskrit: "Ṣoḍaśamaḥ", status: "completed" },
            { id: 17, title_thai: "สัปตทศมธยาย", title_sanskrit: "Saptadaśamaḥ", status: "completed" },
            { id: 18, title_thai: "อัษฎาทศมธยาย", title_sanskrit: "Aṣṭādaśamaḥ", status: "completed" },
            { id: 19, title_thai: "เอกานนวินศติมธยาย", title_sanskrit: "Ekānnaviṁśatimaḥ", status: "completed" },
            { id: 20, title_thai: "วินศติตมธยาย", title_sanskrit: "Viṁśatitamaḥ", status: "completed" },
            { id: 21, title_thai: "เอกวินศติตมธยาย", title_sanskrit: "Ekaviṁśatitamaḥ", status: "completed" },
            { id: 22, title_thai: "ทวาวินศติตมธยาย", title_sanskrit: "Dvāviṁśatitamaḥ", status: "completed" },
            { id: 23, title_thai: "ตรโยวินศติตมธยาย", title_sanskrit: "Trayoviṁśatitamaḥ", status: "completed" },
            { id: 24, title_thai: "จตุรวินศติตมธยาย", title_sanskrit: "Caturviṁśatitamaḥ", status: "completed" },
            { id: 25, title_thai: "ปัญจวินศติตมธยาย", title_sanskrit: "Pañcaviṁśatimaḥ", status: "completed" },
            { id: 26, title_thai: "ษัฑวินศติตมธยาย", title_sanskrit: "Ṣaḍviṁśatimaḥ", status: "completed" }
        ],
    ...
    }
    {
        ...
        chapters: [
            ...
            { id: 2, title_thai: "พระราชอุทยานฝ่ายใน", status: "completed" },
            { id: 3, title_thai: "การเกิดความสังเวช", status: "completed" },
            { id: 4, title_thai: "การกำจัดสตรี", status: "completed" },
            { id: 5, title_thai: "การเสด็จออกผนวช", status: "completed" },
            { id: 6, title_thai: "การเสด็จกลับของฉันนะ", status: "completed" },
            { id: 7, title_thai: "การเข้าสู่อาศรม", status: "completed" },
            { id: 8, title_thai: "ความคร่ำครวญของฝ่ายใน", status: "completed" },
            { id: 9, title_thai: "การตามหาพระกุมาร", status: "completed" },
            { id: 10, title_thai: "การเข้าเฝ้าพระเจ้าพิมพิสาร", status: "completed" },
            { id: 11, title_thai: "การตำหนิกาม", status: "completed" },
            { id: 12, title_thai: "การพบอาราฑะ", status: "completed" },
            { id: 13, title_thai: "ชัยชนะเหนือมาร", status: "completed" },
            { id: 14, title_thai: "สรรคที่ 14", status: "completed" }
        ],
