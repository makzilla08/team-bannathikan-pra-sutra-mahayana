...
const SUTRAS_DATA = [
    ...
    },
    {
        ...
        chapters: [
            ...
            { id: 5, title_thai: "รัศมีนานาชนิด", status: "pending" },
            { id: 6, title_thai: "สนทนากับพระตถาคต", status: "pending" },
            { id: 7, title_thai: "กองบุญของอวโลกิเตศวร", status: "pending" },
            { id: 8, title_thai: "แสดงธรรมแก่เวไนย", status: "pending" },
            { id: 9, title_thai: "ปลอบโยนอสูร", status: "pending" },
            { id: 10, title_thai: "พื้นดินเป็นทองคำ", status: "pending" },
            { id: 11, title_thai: "ปลอบโยนพระพลิ", status: "pending" },
            { id: 12, title_thai: "ปลอบโยนพวกยักษ์", status: "pending" },
            { id: 13, title_thai: "เที่ยวภพเทวดา", status: "pending" },
            { id: 14, title_thai: "เที่ยวสิงหลทวีป", status: "pending" },
            { id: 15, title_thai: "เที่ยวพาราณสี", status: "pending" },
            { id: 16, title_thai: "เที่ยวมคธ", status: "pending" },
            { id: 17, title_thai: "พรรณนาพระอัศวราช", status: "pending" },
    ...
    },
    {
        ...
        priority: 11,
        status: "pending",
        description: "พระสูตรเกี่ยวกับการปฏิบัติเพื่อบรรลุเป็นวัชรสัตตวะ",
        chapters_count: 1,
        chapters: [
            { id: 1, title_thai: "เนื้อหา", status: "pending" }
        ],
