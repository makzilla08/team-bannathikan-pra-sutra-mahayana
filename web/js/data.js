...
const SUTRAS_DATA = [
    ...
    },
    {
        ...
        chapters: [
            ...
            { id: 6, title_thai: "บทที่ 6 - ว่าด้วยคุณแห่งพระนาม (On the Virtue of the Name)", status: "pending" },
            { id: 7, title_thai: "บทที่ 7 - ว่าด้วยสี่ลักษณะ (On the Four Aspects)", status: "pending" },
            { id: 8, title_thai: "บทที่ 8 - ว่าด้วยสี่ที่พึ่ง (On the Four Dependables)", status: "pending" },
            { id: 9, title_thai: "บทที่ 9 - ว่าด้วยผิดและถูก (On Wrong and Right)", status: "pending" },
            { id: 10, title_thai: "บทที่ 10 - ว่าด้วยอริยสัจสี่ (On the Four Truths)", status: "pending" },
            { id: 11, title_thai: "บทที่ 11 - ว่าด้วยวิปาลาสสี่ (On the Four Inversions)", status: "pending" },
            { id: 12, title_thai: "บทที่ 12 - ว่าด้วยตถาคตครรภ์ (On the Nature of the Tathagata)", status: "pending" },
            { id: 13, title_thai: "บทที่ 13 - ว่าด้วยอักษร (On Letters)", status: "pending" },
            { id: 14, title_thai: "บทที่ 14 - ว่าด้วยนิทานนก (On the Parable of the Birds)", status: "pending" },
            { id: 15, title_thai: "บทที่ 15 - ว่าด้วยนิทานจันทร์ (On the Parable of the Moon)", status: "pending" },
            { id: 16, title_thai: "บทที่ 16 - ว่าด้วยพระโพธิสัตว์ (On the Bodhisattva)", status: "pending" },
            { id: 17, title_thai: "บทที่ 17 - ว่าด้วยปัญหาของหมู่ชน (On the Questions Raised by the Crowd)", status: "pending" },
            { id: 18, title_thai: "บทที่ 18 - ว่าด้วยอาพาธที่แท้จริง (On Actual Illness)", status: "pending" },
            { id: 19, title_thai: "บทที่ 19 - ว่าด้วยอริยธรรม (ก) (On Holy Actions a)", status: "pending" },
            { id: 20, title_thai: "บทที่ 20 - ว่าด้วยอริยธรรม (ข) (On Holy Actions b)", status: "pending" },
            { id: 21, title_thai: "บทที่ 21 - ว่าด้วยบริสุทธิธรรม (ก) (On Pure Actions a)", status: "pending" },
            { id: 22, title_thai: "บทที่ 22 - ว่าด้วยบริสุทธิธรรม (ข) (On Pure Actions b)", status: "pending" },
            { id: 23, title_thai: "บทที่ 23 - ว่าด้วยบริสุทธิธรรม (ค) (On Pure Actions c)", status: "pending" },
            { id: 24, title_thai: "บทที่ 24 - ว่าด้วยบริสุทธิธรรม (ง) (On Pure Actions d)", status: "pending" },
            { id: 25, title_thai: "บทที่ 25 - ว่าด้วยบริสุทธิธรรม (จ) (On Pure Actions e)", status: "pending" },
            { id: 26, title_thai: "บทที่ 26 - ว่าด้วยอาการแห่งบุตร (On the Action of the Child)", status: "pending" },
            { id: 27, title_thai: "บทที่ 27 - พระมหากษัตริย์ผู้เปี่ยมศีล (ก) (Highly-Virtuous King a)", status: "pending" },
            { id: 28, title_thai: "บทที่ 28 - พระมหากษัตริย์ผู้เปี่ยมศีล (ข) (Highly-Virtuous King b)", status: "pending" },
            { id: 29, title_thai: "บทที่ 29 - พระมหากษัตริย์ผู้เปี่ยมศีล (ค) (Highly-Virtuous King c)", status: "pending" },
            { id: 30, title_thai: "บทที่ 30 - พระมหากษัตริย์ผู้เปี่ยมศีล (ง) (Highly-Virtuous King d)", status: "pending" },
            { id: 31, title_thai: "บทที่ 31 - พระมหากษัตริย์ผู้เปี่ยมศีล (จ) (Highly-Virtuous King e)", status: "pending" },
            { id: 32, title_thai: "บทที่ 32 - พระมหากษัตริย์ผู้เปี่ยมศีล (ฉ) (Highly-Virtuous King f)", status: "pending" },
            { id: 33, title_thai: "บทที่ 33 - พระโพธิสัตว์สิงหราช (ก) (Lion's Roar a)", status: "pending" },
            { id: 34, title_thai: "บทที่ 34 - พระโพธิสัตว์สิงหราช (ข) (Lion's Roar b)", status: "pending" },
            { id: 35, title_thai: "บทที่ 35 - พระโพธิสัตว์สิงหราช (ค) (Lion's Roar c)", status: "pending" },
            { id: 36, title_thai: "บทที่ 36 - พระโพธิสัตว์สิงหราช (ง) (Lion's Roar d)", status: "pending" },
            { id: 37, title_thai: "บทที่ 37 - พระโพธิสัตว์สิงหราช (จ) (Lion's Roar e)", status: "pending" },
            { id: 38, title_thai: "บทที่ 38 - พระโพธิสัตว์สิงหราช (ฉ) (Lion's Roar f)", status: "pending" },
            { id: 39, title_thai: "บทที่ 39 - พระโพธิสัตว์สิงหราช (ช) (Lion's Roar g)", status: "pending" },
            { id: 40, title_thai: "บทที่ 40 - พระโพธิสัตว์กัสยป (ก) (Kasyapa a)", status: "pending" },
            { id: 41, title_thai: "บทที่ 41 - พระโพธิสัตว์กัสยป (ข) (Kasyapa b)", status: "pending" },
            { id: 42, title_thai: "บทที่ 42 - พระโพธิสัตว์กัสยป (ค) (Kasyapa c)", status: "pending" },
            { id: 43, title_thai: "บทที่ 43 - พระโพธิสัตว์กัสยป (ง) (Kasyapa d)", status: "pending" },
            { id: 44, title_thai: "บทที่ 44 - พระโพธิสัตว์กัสยป (จ) (Kasyapa e)", status: "pending" },
            { id: 45, title_thai: "บทที่ 45 - ว่าด้วยโกณฑินยะ (ก) (Kaundinya a)", status: "pending" },
            { id: 46, title_thai: "บทที่ 46 - ว่าด้วยโกณฑินยะ (ข) (Kaundinya b)", status: "pending" },
        ],
